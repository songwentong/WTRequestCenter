#
#  Be sure to run `pod spec lint WTRequestCenter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author       = { "宋文通" => "275712575@qq.com" }
  # s.authors      = { "宋文通" => "275712575@qq.com", "other author" => "email@address.com" }
  # s.author       = '宋文通', 'other author'
  ...
  s.source_files  = 'WTRequestCenter/WTRequestCenter/NSURLRequest.{h,m}','WTRequestCenter/UIKit+WTRequestCenter.{h,m}'
